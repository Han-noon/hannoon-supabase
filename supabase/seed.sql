...
-- articles: 여당 과반 확보 (5건 - left 2, mid 2, right 1)
INSERT INTO public.articles (feed_url, guid, link, category, title, summary, content_source, publisher, published_at, bias_type, status) VALUES
  ('https://feeds.example.com/hani', 1001, 'https://www.hani.co.kr/arti/politics/1001', '정치', '여당, 과반 의석 확보…야권 충격', '22대 총선에서 여당이 단독 과반을 넘기며 압승을 거뒀다.', 'rss', '한겨레', '2024-04-11 09:00:00', 'left', 'ready'),
  ('https://feeds.example.com/ohmynews', 1002, 'https://www.ohmynews.com/politics/1002', '정치', '총선 결과, 여당 독주 시대 개막하나', '여당의 과반 확보로 단독 입법이 가능해졌다는 분석이 나온다.', 'rss', '오마이뉴스', '2024-04-11 10:30:00', 'left', 'ready'),
  ('https://feeds.example.com/yonhap', 1003, 'https://www.yna.co.kr/politics/1003', '정치', '22대 총선 여당 과반 확보 확정', '중앙선거관리위원회는 여당이 과반 의석을 확보했다고 공식 발표했다.', 'rss', '연합뉴스', '2024-04-11 08:00:00', 'mid', 'ready'),
  ('https://feeds.example.com/khan', 1004, 'https://www.khan.co.kr/politics/1004', '정치', '총선 여당 승리…여야 반응 엇갈려', '여당은 민심의 승리라 자평했고 야권은 결과를 수용하며 쇄신을 다짐했다.', 'rss', '경향신문', '2024-04-11 11:00:00', 'mid', 'ready'),
  ('https://feeds.example.com/chosun', 1005, 'https://www.chosun.com/politics/1005', '정치', '여당 압승, 안정적 국정 운영 기반 마련', '여당의 과반 확보로 국정 운영에 탄력이 붙을 것이라는 전망이 나온다.', 'rss', '조선일보', '2024-04-11 12:00:00', 'right', 'ready');

-- articles: 금리 0.25%p 인상 결정 (4건 - left 1, mid 2, right 1)
INSERT INTO public.articles (feed_url, guid, link, category, title, summary, content_source, publisher, published_at, bias_type, status) VALUES
  ('https://feeds.example.com/hani', 2001, 'https://www.hani.co.kr/arti/economy/2001', '경제', '한은 금리 인상, 서민 이자 부담 가중 우려', '기준금리 인상으로 가계 대출 이자 부담이 크게 늘어날 전망이다.', 'rss', '한겨레', '2024-01-12 10:00:00', 'left', 'ready'),
  ('https://feeds.example.com/yonhap', 2002, 'https://www.yna.co.kr/economy/2002', '경제', '한국은행, 기준금리 0.25%p 인상 결정', '한국은행 금융통화위원회가 기준금리를 연 3.50%로 인상했다.', 'rss', '연합뉴스', '2024-01-12 09:00:00', 'mid', 'ready'),
  ('https://feeds.example.com/khan', 2003, 'https://www.khan.co.kr/economy/2003', '경제', '금통위 금리 인상…물가 안정 목적', '물가 안정을 위한 긴축 기조 유지 차원에서 금리 인상을 결정했다고 한은이 밝혔다.', 'rss', '경향신문', '2024-01-12 11:00:00', 'mid', 'ready'),
  ('https://feeds.example.com/chosun', 2004, 'https://www.chosun.com/economy/2004', '경제', '기준금리 인상, 인플레 방어 적절한 조치', '전문가들은 이번 금리 인상이 물가 안정에 기여할 것이라고 평가했다.', 'rss', '조선일보', '2024-01-12 13:00:00', 'right', 'ready');
