...
SELECT has_column('public', 'profiles', 'profile_image_path', 'profile_image_path 컬럼이 존재해야 한다');
...
SELECT col_type_is('public', 'profiles', 'profile_image_path', 'text',              'profile_image_path는 text 타입이어야 한다');
...
-- update_profile_image_url 함수 제거 확인
SELECT hasnt_function('public', 'update_profile_image_url', ARRAY['text'], 'update_profile_image_url(text) 함수는 제거되어야 한다');
...
INSERT INTO public.profiles (id, email, profile_image_path) VALUES
  ('aaaaaaaa-0000-0000-0000-000000000001', 'rls_test_a@example.com', 'aaaaaaaa-0000-0000-0000-000000000001/profile'),
  ('bbbbbbbb-0000-0000-0000-000000000002', 'rls_test_b@example.com', 'bbbbbbbb-0000-0000-0000-000000000002/profile');
...
SELECT is(
  public.get_profile()->>'id',
  'aaaaaaaa-0000-0000-0000-000000000001',
  'get_profile은 본인 id를 반환해야 한다'
);

SELECT is(
  public.get_profile()->>'profile_image_path',
  'aaaaaaaa-0000-0000-0000-000000000001/profile',
  'get_profile은 profile_image_path를 반환해야 한다'
);
...
--
-- name / profile_image_path 채움 여부는 실제 Google OAuth 흐름으로 검증한다.
